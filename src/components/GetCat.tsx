...
export const GetCat = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div className=" w-46 border-sky-500 border-2 p-1 flex flex-row items-center justify-center">
                <div  >
                ...
                <div className="" >
                    ...
                    <select id='catTag' className="rounded border-sky-500 border-2 hover:border-green-700"
                        value={valueTag} onChange={handleChangeTag}>
